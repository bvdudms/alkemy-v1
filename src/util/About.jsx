    ...
    <div className='mt-8 flex flex-wrap lg:px-16 lg:pl-20 justify-between'>
      <div className="w-full lg:w-[60%] lg:pl-12 max-sm:px-7">
        <div className="">
          ...
          <p className='text-white lg:text-lg max-sm:text-xs lg:mt-12 max-sm:mt-3 tracking-wide font-mono '>
            ...
            <div className=" flex">
            <p className='text-white max-sm:text-md lg:text-4xl mt-5 lg:pr-32 tracking-widest font-mono'>MESSAGE BY HON'BLE DR. PATANGRAO KADAM:</p>
            <img src={patang} alt=""  className='sm:hidden w-[70px] rounded-xl'/>
            </div>
          
          <p className='text-white lg:text-lg lg:mt-5 max-sm:mt-2 max-sm:text-xs tracking-wide font-mono'>BHARATI VIDYAPEETH (DEEMED TO BE UNIVERSITY) IS COMMITTED TO BRINGING ABOUT SOCIAL EMPOWERMENT THROUGH DYNAMIC EDUCATION. IT HAS BEEN ABLE TO STAND TALL IN THE FIELD OF EDUCATION IN THE PAST AS WELL AS IN MODERN TIMES. OUR JOURNEY OF FOUR DECADES HAS EARNED PRIDE FOR US AS A UNIVERSITY. WE, AT BHARATI VIDYAPEETH (DEEMED TO BE UNIVERSITY), HAVE BEEN WORKING RELENTLESSLY TOWARDS FULFILLING OUR MISSION 'SOCIAL TRANSFORMATION THROUGH DYNAMIC EDUCATION'. WHILE PURSUING THIS MISSION, WE ARE PREPARED TO ACCEPT NEW CHALLENGES POSITIVELY.</p>
          <p className='text-white lg:text-lg mt-5 max-sm:text-xs tracking-wide font-mono'>LET US STRIVE TOGETHER TO BUILD OUR NATION!</p>
        </div>
      </div>
      <div className="w-full lg:w-1/3 gap-4 flex flex-col justify-center items-center">
        <div className="self-center flex flex-col justify-center max-sm:hidden">
          ...
          <p className='text-white font-sp font-bold px-12 text-center text-lg'>Hon'ble Dr. Patangrao Kadam
