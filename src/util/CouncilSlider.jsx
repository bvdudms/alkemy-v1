...
const CustomPrevArrow = (props) => {
  ...
  return (
    <button
      className="absolute text-yellow-500 top-1/2 left-0 transform -translate-y-1/2 -translate-x-4 md:-translate-x-6  w-20 h-20 flex justify-center items-center focus:outline-none"
      onClick={onClick}
    >
...
const CustomNextArrow = (props) => {
  ...
  return (
    <button
      className="absolute text-yellow-500 top-1/2 right-0 transform -translate-y-1/2 translate-x-4 md:translate-x-6 w-20 h-20 flex justify-center items-center focus:outline-none"
      onClick={onClick}
    >
