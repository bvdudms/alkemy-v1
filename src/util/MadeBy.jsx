...
import parikha from '../../image/parikha.jpg'
    ...
    <div>
      ...
      <div className="mt-8 flex justify-center max-md:hidden">
        ...
        <div className="grid grid-cols-4 gap-8">
          ...
          <div className="w-[250px] h-[250px] flex flex-col gap-2 items-center mb-6">
            <a href="https://linktr.ee/kritansh_tank">
      ...
      <div className="mt-8 flex justify-center max-md:hidden">
        <div className="grid grid-cols-3 gap-8">
          <div className="w-[250px] h-[250px] flex flex-col gap-2 items-center mb-6">
            <img src={parikha} alt="" className='w-[200px] h-[200px] rounded-3xl' />
            <p className='text-center text-white text-lg font-homo font-bold'>PARIKHA KATHANE</p>
            <p className='-mt-1 text-center text-white text-sm font-bold'>(BROCHURE LOGO)</p>
            <p className='-mt-1 text-center text-white text-sm font-bold'>TY CSBS</p>
          </div>
          <div className="w-[250px] h-[250px] flex flex-col gap-2 items-center mb-6">
            ...
            <p className='-mt-1 text-center text-white text-sm font-bold'>(WEBSITE LOGO)</p>
            <p className='-mt-1 text-center text-white text-sm font-bold'>SY CSE</p>
          </div>
          <div className="w-[250px] h-[250px] flex flex-col gap-2 items-center mb-6">
            ...
            <p className='-mt-1 text-center text-white text-sm font-bold'>FINAL YEAR CSE</p>
          </div>
        </div>
      </div>
      <div>
